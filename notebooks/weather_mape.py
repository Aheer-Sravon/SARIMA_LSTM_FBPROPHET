...
# Load the CSV data
walmart_data = pd.read_csv('../data/weather_metrices.csv')
...
ax.set_title('MAPE Comparison - Coffee Sales Dataset', fontsize=11, fontweight='medium', pad=10)
...
arrow_length = y_range * 0.8  # 20% of the data range
...
plt.savefig('./assets/weather_mape.png', dpi=600, bbox_inches='tight')
plt.savefig('./assets/weather_mape.pdf', bbox_inches='tight')
