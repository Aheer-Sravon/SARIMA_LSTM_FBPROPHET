...
ax.set_title('RMSE Comparison - Walmart Dataset (Store 3)', fontsize=11, fontweight='medium', pad=10)  # Changed title
...
arrow_length = y_range * 0.5  # 15% of the data range
...
plt.savefig('walmart_rmse.png', dpi=600, bbox_inches='tight')  # Changed filename
plt.savefig('walmart_rmse.pdf', bbox_inches='tight')  # Changed filename
